...
function getPlanteForJardinier(){
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
            var strData="<option value=''>Chosire une Plante</option>";
            for(i=0;i<data.data.length;i++){
                strData+="<option value='"+data.data[i][0]+"'>"+data.data[i][1]+"</option>"; 
            }
            document.getElementById("planteContenu").innerHTML=strData;
        }
    }
    xhr.open("POST","getPlanteForJardinier",true);
    var f=new FormData();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);
...
function getJardinForContenu(){
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
            var strData="<option value=''>Chosire une Jardin</option>";
            for(i=0;i<data.data.length;i++){
                strData+="<option value='"+data.data[i][0]+"'>"+data.data[i][1]+"</option>"; 
            }
            document.getElementById("jardinContenu").innerHTML=strData;
        }
    }
    xhr.open("POST","getJardinForContenu",true);
    var f=new FormData();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);
}
function submitContenu(){
    var datePlantation=document.getElementById("datePlantationContenu").value;
    var qte=document.getElementById("qteContenu").value;
    var plante=document.getElementById("planteContenu").value;
    var jardin=document.getElementById("jardinContenu").value;
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    
    if (datePlantation!="" && qte!="" && plante!="" && jardin!=""){
     var f=new FormData();
     f.append("datePlantation",datePlantation);
     f.append("qte",qte);
     f.append("plante",plante);
     f.append("jardin",jardin);
     if(document.getElementById("submitContenu").value=="Moddifier")
        f.append("id",idContenu);
     f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
     var xhr=new XMLHttpRequest();
     xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
     ...
     if(document.getElementById("submitContenu").value=="Moddifier")
     xhr.open("POST","updateContenu",true);
     else
     xhr.open("POST","addContenu",true);
     xhr.send(f);
    }else 
    toastr.warning("SVP remplire tout la formulaire !!","",{positionClass:"toast-bottom-right"})
}
function hideFormContenu(){
    document.getElementById("formulaire").classList.add("formulaire");
    document.getElementById("formulaire").classList.remove("showFormulaire");    
    document.getElementById("submitContenu").value="Ajouter";
    document.getElementById("datePlantationContenu").value="";
    document.getElementById("qteContenu").value="";
    document.getElementById("planteContenu").value="";
    document.getElementById("jardinContenu").value="";

}
var contenuOffset=0;
function getDataContenu(){
    getNbrePlanteParJardin();
    getNbreJardinParContenu();
    getTheLatestAddedContenu();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.readyState==4 && this.status==200){
            ...
            if(data.data.length){
                ...
                for(i=0;i<data.data.length;i++){
                    ...
                    strData+="<tr><td><img src='/media/"+data.data[i][3]+"' class='comptImage'></td><td>"+data.data[i][5]+"</td><td>"+data.data[i][11]+" </td><td>"+data.data[i][13]+"</td><td>"+data.data[i][0]+"</td><td>"+data.data[i][1]+"</td><td><ion-icon onclick='deleteContenu("+data.data[i][15]+")' class='Icon Icon_delete' name='trash-outline'></ion-icon></td><td><ion-icon onclick='updateContenu("+JSON.stringify(data.data[i])+","+data.data[i][15]+")' class='Icon Icon_update' name='pencil-outline'></ion-icon></td><td><ion-icon onclick='detailContenu("+JSON.stringify(data.data[i])+","+data.data[i][15]+")' class='Icon Icon_details' name='information-outline'></ion-icon></td></tr>";         
                }
                document.getElementById("listContenu").innerHTML=strData;
            }else
        offsetJardin=offsetJardin-5;
    ...
    xhr.open("POST","getDataContenu",true);
    var f=new FormData();
    f.append("offset",contenuOffset);
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);
}
function deleteContenu(id){
    if(window.confirm("Voulez vous vraiment supprimer cet contenu")){
        var xhr=new XMLHttpRequest();
        xhr.onreadystatechange=function(){
            if(this.status==200 && this.readyState==4){
        ...
        xhr.open("POST","deleteContenu",true);
        var f=new FormData();
        var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
        f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
        f.append("id",id);
...
var idContenu=0;
function updateContenu(data,id){
    showForm();
    document.getElementById("submitContenu").value="Moddifier";
    document.getElementById("datePlantationContenu").value=data[1];
    document.getElementById("qteContenu").value=data[0];
    document.getElementById("planteContenu").value=data[9];
    document.getElementById("jardinContenu").value=data[2];
    idContenu=id;
}

function detailContenu(data,id){
    document.getElementById("detailForm").classList.remove("detailForm");
    document.getElementById("detailForm").classList.add("showDetailForm");
    document.getElementById("datePlantationContenuDetail").innerHTML=data[0];
    document.getElementById("qteContenuDetail").innerHTML=data[1];
    document.getElementById("photoDetailJardin").src='/media/'+data[3];
    document.getElementById("nomtDetailJardinContenu").innerHTML=data[5];
    document.getElementById("NumeroDetailJardinContenu").innerHTML=data[4];
    document.getElementById("adresseDetailJardinierContenu").innerHTML=data[7];
    document.getElementById("villeDetailJardinierContenu").innerHTML=data[6];
    document.getElementById("superficierDetailJardinierContenu").innerHTML=data[8];
    document.getElementById("serieDetailPlanteContenu").innerHTML=data[10];
    document.getElementById("nomDetailPlanteContenu").innerHTML=data[11];
    document.getElementById("orogineDetailPlanteContenu").innerHTML=data[12];
    document.getElementById("typeDetailPlanteContenu").innerHTML=data[13];
    document.getElementById("prixDetailPlanteContenu").innerHTML=data[14];
      
}
function searchContenu(){
    var datePlantation=document.getElementById("datePlantationSearch").value;
    var qte=document.getElementById("qteSearch").value;
    var nomJardin=document.getElementById("nomJardinSearch").value;
    var nomPlante=document.getElementById("nomPlanteSearch").value;
    var typelante=document.getElementById("typelanteSearch").value;
    var villeJardin=document.getElementById("villeJardinSearch").value;
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
    ...
    xhr.open("POST","searhContenu",true);
    var f=new FormData();
    f.append("datePlantation",datePlantation);
    f.append("nomJardin",nomJardin);
    f.append("nomPlante",nomPlante);
    f.append("typelante",typelante);
    f.append("villeJardin",villeJardin);
    f.append("qte",qte);        
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);
}
var getNbreJardinParContenuChart = null; 
function getNbreJardinParContenu(){
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status=200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
            ...
            if(getNbreJardinParContenuChart!=null){
                getNbreJardinParContenuChart.destroy();
            }
            getNbreJardinParContenuChart = new Chart(document.getElementById("getNbreJardinParContenuChart"),config);                

        }
    }
    xhr.open("POST","getNbreJardinParContenu",true);
    var f=new FormData();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);   
}
var getNbrePlanteParJardinChart=null;
function getNbrePlanteParJardin(){
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status=200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
            ...
            if(getNbrePlanteParJardinChart!=null){
                getNbrePlanteParJardinChart.destroy();
            }
            getNbrePlanteParJardinChart = new Chart(document.getElementById("getNbrePlanteParJardinChart"),config);                

        }
    }
    xhr.open("POST","getNbrePlanteParJardin",true);
    var f=new FormData();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);   
...
function getTheLatestAddedContenu(){
    var xhr=new XMLHttpRequest();
    xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            var data=JSON.parse(this.responseText);
            var strData="";
            for(i=0;i<data.data.length;i++){
                strData+="<div class='latestItemAdded'>&nbsp;&nbsp; <img src='/media/"+data.data[i][1]+"' class='comptImage'><div id='fullNameLatesAdded'>"+data.data[i][0]+"</div> </div>";
            }
            document.getElementById("listLatestAdded").innerHTML=strData;           
        }
    }
    xhr.open("POST","getTheLatestAddedContenu",true);
    var f=new FormData();
    var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
    f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);
    xhr.send(f);   
...
function updateCompt(){
    var photo=document.getElementById("photoCompt").files[0];
    var cni=document.getElementById("cniCompt").value;
    var nom=document.getElementById("nomCompt").value;
    var prenom=document.getElementById("prenomCompt").value;
    var email=document.getElementById("emailCompt").value;
    var pw=document.getElementById("pwCompt").value;
    var id=document.getElementById("idCompt").value;
    if(cni!="" && nom!="" && prenom!="" && email!="" && pw!=""){
      var f=new FormData();
      f.append("cni",cni);
      f.append("nom",nom);
      f.append("prenom",prenom);
      ...
      var csrfmiddlewaretoken=document.getElementsByName("csrfmiddlewaretoken")[0].value;
      f.append("csrfmiddlewaretoken",csrfmiddlewaretoken);  
      if(document.getElementById("photoCompt").files.length==1){
        f.append("photo",photo);
      }
      f.append("cni",cni);
      var xhr=new XMLHttpRequest();
      xhr.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            ...
            if(type=="success"){
                toastr.success(message,"",{positionClass:"toast-bottom-right"});
                window.location.href='/compt';

            }
            }
      }
      xhr.open("POST","updateCompt",true);
      xhr.send(f);
    }else
    toastr.warning("SVP remplire toute les champs !!","",{positionClass:"toast-bottom-right"});
}